        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function setTheme(isLight) {
                if (isLight) {
                    ...
                    if (footerLogo) footerLogo.src = 'assets/trademarks/logos/Black Horizontal Logo TM.webp';
                } else {
                    document.body.classList.remove('light-mode');
                    // When setting to dark mode, the button should display "Light Mode" (sun symbol) to suggest switching to light.
                    if (desktopThemeSymbol) desktopThemeSymbol.textContent = '☀';
                    if (footerLogo) footerLogo.src = 'assets/trademarks/logos/White Horizontal Logo TM.webp';
                }
